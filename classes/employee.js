        ...
        return Inquirer.prompt([
            {
                type: "input", 
                name: "manager_id", 
                message: "What is the ID of the manager whose employees you would like to see", 
                validate: isNullableIntValidator
            }
        ])
        .then(({manager_id}) => {
        ...
        return Inquirer.prompt([
            {
                type: "input", 
                name: "department_id", 
                message: "What is the ID of the department whose employees you would like to see", 
                validate: isNullableIntValidator
            }
        ])
        .then(({department_id}) => {
